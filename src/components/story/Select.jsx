    ...
    <div className="flex flex-col gap-4 w-full">
      {options.map((option, idx) => {
        ...
        return (
          <button
            key={option}
            className={`w-full h-[55px] rounded-[15px] font-pretendard text-[16px] font-semibold leading-[140%] tracking-[-0.4px] px-6 flex items-center justify-center select-none transition-all break-words whitespace-pre-line
              ${
                isSelected
