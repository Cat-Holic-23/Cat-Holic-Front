...
export default function Speech({ children }) {
  return (
    <div className="relative w-[320px] bg-white rounded-[15px] flex justify-center items-center px-0 py-4 text-center text-[16px] font-semibold text-[#424242] leading-[140%] tracking-[-0.4px] mx-auto mb-8 shadow-[0px_4px_0px_rgba(255,185,50,0.45)] font-pretendard">
